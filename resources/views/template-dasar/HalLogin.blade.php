...
<head>
        ...
        <title>MSI Kota Semarang</title>
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="images\logo_msikota.png" stylesheet="width: 50px; height: 25%;"/>
    ...
    <section class="page-section bg-light">
        <div class="container" style="padding-top:7%; padding-bottom:10%">
            <div class="row justify-content-center" style="margin-bottom:5%">
                <img src="/public/images/logo_msikota.png" alt="..." style="width:300px; "/>
                <h2 class="masthead-heading text-uppercase text-dark text-center" style="padding-top:1%">Kota Semarang</h2>
            </div>
