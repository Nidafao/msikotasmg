    ...
    <nav class="navbar navbar-expand-lg bg-light shadow-lg">
        <div class="container">
            <a class="navbar-brand" href="index.php">
                <img src="/public/images/logo_msikota.png" class="logo img-fluid" alt="Logo">
                <span>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link click-scroll" href="/public">Home</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link click-scroll" href="/public">Tentang Kami</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link click-scroll" href="/public">Kontak</a>
                    </li>
                    ...
                    <li class="nav-item ms-3">
                        <a class="nav-link custom-btn custom-border-btn btn" href="/public/login">Login Admin</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-4">
                    ...
                    <ul class="footer-menu">
                        <li class="footer-menu-item"><a href="ketuk-pintu" class="footer-menu-link">Ketuk Pintu</a></li>

                        <li class="footer-menu-item"><a href="grebek" class="footer-menu-link">Grebek TBC</a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-7 col-12">
                        <p class="copyright-text mb-0">Copyright © 2023 <a href="index.php">SSR MSI Kota Semarang</a>
                        </p>
                    </div>
